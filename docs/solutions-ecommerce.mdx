...
Full code of this demo is available here: https://github.com/elastic/search-ui/tree/test-live-demo-error/examples/sandbox, with the Ecommerce code located under `pages/ecommerce`.
